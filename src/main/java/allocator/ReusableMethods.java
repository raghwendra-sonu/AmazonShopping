...
public class ReusableMethods {
	...
	public String scrollAndClick(String AppElement) throws Exception {
		try {
		   Thread.sleep(5000);
		   Point value = null;
		   MobileElement element =  FindAnElement(AppElement);
		   System.out.println("Product selected is: "+element.getText());
		   productDetails=element.getText();
